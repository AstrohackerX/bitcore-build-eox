...
function startGulp(name, opts) {
  ...
  var buildPath = './node_modules/bitcore-build-eox/';
  ...
  if (browser) {
    ...
    if (name !== 'lib') {
      browserifyCommand = buildBinPath + 'browserify --require ./index.js:' + fullname + ' --external bitcore-lib-eox -o ' + fullname + '.js';
    } else {
      browserifyCommand = buildBinPath + 'browserify --require ./index.js:bitcore-lib-eox -o bitcore-lib-eox.js';
    }
